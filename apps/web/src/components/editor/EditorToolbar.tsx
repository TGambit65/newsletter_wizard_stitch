...
export function EditorToolbar({
  ...
  return (
    <>
      {/* Toolbar */}
      {!isSent && (
        <div className="flex items-center gap-1 p-2 border-b border-neutral-200 dark:border-white/10 flex-wrap">
          <button
            onClick={() => editor?.chain().focus().toggleBold().run()}
            className={clsx(
              'p-2 rounded hover:bg-neutral-100 dark:hover:bg-white/5',
          ...
          <button
            ...
            className="p-2 rounded hover:bg-neutral-100 dark:hover:bg-white/5"
          >
          ...
          {generationHistoryCount > 0 && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-medium text-sm text-neutral-600 dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-white/5 transition-colors"
      ...
      {/* AI Panel */}
      {showAIPanel && !isSent && (
        <div className="p-4 border-b border-neutral-200 dark:border-white/10 bg-primary-50/50 dark:bg-primary-900/10">
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 px-3 py-2 bg-white dark:bg-surface-dark border border-neutral-200 dark:border-white/10 rounded-lg focus:ring-2 focus:ring-primary-500 outline-none"
          ...
          <div className="flex gap-2 mt-3">
            {['Expand on this', 'Make it punchier', 'Add a call to action', 'Summarize'].map((suggestion) => (
              <button
                ...
                className="px-3 py-1 bg-white dark:bg-surface-dark border border-neutral-200 dark:border-white/10 rounded-full text-sm text-neutral-600 dark:text-neutral-400 hover:border-primary-300"
              >
                {suggestion}
              </button>
            ))}
      ...
      {showAIFeedback && !isSent && (
        <div className="px-4 pb-3 border-b border-neutral-200 dark:border-white/10 bg-primary-50/30 dark:bg-primary-900/5">
          <AIFeedback
