...
export function DeleteAccountPage() {
  ...
  function handleExport() {
    // Simulate data export — real implementation calls export-user-data edge fn
    const blob = new Blob([JSON.stringify({
      exported_at: new Date().toISOString(),
      note: 'Full data export would be generated by the server',
  ...
  async function handleDelete() {
    ...
    setDeleting(true);
    // Simulate delete — real implementation calls delete-account edge fn
